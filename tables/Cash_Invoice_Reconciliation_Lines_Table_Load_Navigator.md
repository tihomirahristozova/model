# Query Cash_Invoice_Reconciliation_Lines_Table_Load_Navigator
...
|[Payment_Transaction_Document_Id](#payment_transaction_document_id)|`uniqueidentifier` ||
|[Covered_Invoice_Amount](#covered_invoice_amount)|`decimal(0, 0)` ||
|[Default_Invoice_Document_Id](#default_invoice_document_id)|`uniqueidentifier` ||
|[Default_Payment_Transaction_Document_Id](#default_payment_transaction_document_id)|`uniqueidentifier` ||
