...
|Attributes|None|
|Default Value|None|
|Derived From|*Pricing*.*Pricing_Model_Id*|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None|
|Default Value|None|
|Derived From|*Pricing*.*Purchase_Price_Per_Lot*|
|Format|N2|
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None|
|Default Value|None|
|Derived From|*Pricing*.*New_Cost_Per_Lot*|
|Format|N2|
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None|
|Default Value|None|
|Derived From|*Pricing*.*New_Price_Per_Lot*|
|Format|N2|
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None, IsPercent|
|Default Value|None|
|Derived From|*Pricing*.*Default_Margin_Percent*|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
