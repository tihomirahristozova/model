# Query Wms_Warehouse_Requisition_Lines_Table_Load_Navigator
...
|[Quantity](#quantity)|`decimal(0, 0)` |The requested quantity.|
...
|[Quantity_Base](#quantity_base)|`decimal(0, 0)` |Quantity in the base measurement unit of the product.|
...
The type of the requistion. I=Inbound; O=Outbound.
