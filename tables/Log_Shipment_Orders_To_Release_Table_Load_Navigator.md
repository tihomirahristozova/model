# Query Log_Shipment_Orders_To_Release_Table_Load_Navigator
...
|[Sales_Order_Line_Amount](#sales_order_line_amount)|`decimal(0, 0)` Readonly||
...
|[Sales_Order_Currency_Id](#sales_order_currency_id)|`uniqueidentifier` Readonly||
...
|[Shipment_Order_Id_Line_Column](#shipment_order_id_line_column)|`uniqueidentifier` ||
