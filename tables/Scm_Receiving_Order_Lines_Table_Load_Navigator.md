# Query Scm_Receiving_Order_Lines_Table_Load_Navigator
...
|[Confirmed_Quantity_Base](#confirmed_quantity_base)|`decimal(0, 0)` ||
...
|[Purchased_Quantity](#purchased_quantity)|`decimal(0, 0)` ||
|[Purchased_Quantity_Unit_Id](#purchased_quantity_unit_id)|`uniqueidentifier` ||
|[Purchased_Quantity_Base](#purchased_quantity_base)|`decimal(0, 0)` ||
...
|[Received_Quantity_Base](#received_quantity_base)|`decimal(0, 0)` ||
|[Line_Amount_In_Base_Currency](#line_amount_in_base_currency)|`decimal(0, 0)` ||
|[ConfirmQuantity](#confirmquantity)|`decimal(0, 0)` ||
|[ConfirmQuantityBase](#confirmquantitybase)|`decimal(0, 0)` ||
