# Query Nat_BG_VAT_Declarations_Table_Load_Navigator
...
|[VAT_Period_Start](#vat_period_start)|`date` ||
|[VAT_Period_End](#vat_period_end)|`date` ||
|[Declaring_Person_Id](#declaring_person_id)|`uniqueidentifier` ||
