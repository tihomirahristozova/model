# Query Srv_Service_Agreement_Lines_Table_Load_Navigator
...
|[Service_Type_Id](#service_type_id)|`uniqueidentifier` ||
|[Line_Start_Date_Time](#line_start_date_time)|`datetime` ||
|[Line_End_Date_Time](#line_end_date_time)|`datetime` ||
