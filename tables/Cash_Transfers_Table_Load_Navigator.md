# Query Cash_Transfers_Table_Load_Navigator
...
|[Source_Payment_Account_Id](#source_payment_account_id)|`uniqueidentifier` ||
|[Destination_Payment_Account_Id](#destination_payment_account_id)|`uniqueidentifier` ||
|[Source_Amount](#source_amount)|`decimal(0, 0)` ||
|[Source_Currency_Id](#source_currency_id)|`uniqueidentifier` ||
|[Destination_Amount](#destination_amount)|`decimal(0, 0)` ||
|[Destination_Currency_Id](#destination_currency_id)|`uniqueidentifier` ||
