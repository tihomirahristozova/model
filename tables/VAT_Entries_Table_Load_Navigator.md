# Query VAT_Entries_Table_Load_Navigator
...
|[Entry_Id](#entry_id)|`uniqueidentifier` `PK`||
|[Document_Id](#document_id)|`uniqueidentifier` ||
|[Entry_Type](#entry_type)|`nvarchar` Allowed: `P`, `S`||
...
|[Referenced_Document_Type_Id](#referenced_document_type_id)|`uniqueidentifier` ||
|[Referenced_Document_No](#referenced_document_no)|`nvarchar` ||
|[Amount_Base](#amount_base)|`decimal(0, 0)` ||
|[VAT_Amount_Base](#vat_amount_base)|`decimal(0, 0)` ||
