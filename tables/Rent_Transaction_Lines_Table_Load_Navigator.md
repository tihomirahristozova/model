# Query Rent_Transaction_Lines_Table_Load_Navigator
...
|Attributes|None|
|Default Value|None|
|Derived From|[Rent_Transaction_Lines](Rent_Transaction_Lines.md).[Rental_Asset_Id](Rent_Transaction_Lines.md#rental_asset_id)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
