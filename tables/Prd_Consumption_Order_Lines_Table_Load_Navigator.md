# Query Prd_Consumption_Order_Lines_Table_Load_Navigator
...
|[Work_Order_Item_Ingredient_Id](#work_order_item_ingredient_id)|`uniqueidentifier` ||
|[Scheduled_Date_Time](#scheduled_date_time)|`datetime` ||
...
|[Consumed_Quantity_AMU](#consumed_quantity_amu)|`decimal(0, 0)` ||
