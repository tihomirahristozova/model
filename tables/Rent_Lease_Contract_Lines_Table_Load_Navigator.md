# Query Rent_Lease_Contract_Lines_Table_Load_Navigator
...
|[Rental_Date](#rental_date)|`datetime` Readonly||
|[Return_Date](#return_date)|`datetime` Readonly||
|[Reporting_Periods](#reporting_periods)|`int` Readonly||
...
|Attributes|None|
|Default Value|None|
|Derived From|[Rent_Lease_Contract_Lines](Rent_Lease_Contract_Lines.md).[Rental_Asset_Id](Rent_Lease_Contract_Lines.md#rental_asset_id)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
