# Query Log_Shipment_Order_Lines_Not_Shipped_Issued_Quantities_Table_Load_Navigator
...
|[Issued_Quantity](#issued_quantity)|`decimal(0, 0)` ||
...
|[Box_Count](#box_count)|`decimal(0, 0)` ||
