# Query Gen_Document_Prints_Table_Load_Navigator
...
|[Print_Time](#print_time)|`datetime` ||
|[Print_User](#print_user)|`nvarchar` ||
|[Is_Original](#is_original)|`bit` ||
|[Document_Print_Image_Id](#document_print_image_id)|`uniqueidentifier` ||
|[Description](#description)|`nvarchar` ||
|[Printout_Type](#printout_type)|`nvarchar` Allowed: `PPP`, `FPP`, `EXP`, `DWN`|Shows the type of the printout depending on the output interface.|
|[Additional_Data](#additional_data)|`nvarchar` |Contains additional data about the printout. The format of the data is dependent on the Printout Type.|
...
Shows the type of the printout depending on the output interface.
