# Query Crm_Promotional_Package_Lines_Table_Load_Navigator
...
|[Valid_For_Customer_Filter_XML](#valid_for_customer_filter_xml)|`nvarchar` |When not NULL, the package is valid only for the customers, that match the filter|
|[Promotional_Package_Code](#promotional_package_code)|`nvarchar` |Unique code of the promotional package|
...
|[Valid_For_Ship_To_Customer_Filter_XML](#valid_for_ship_to_customer_filter_xml)|`nvarchar` |When not NULL, specifies validity condition for the Ship To Customer of the sales document.|
...
|[Valid_For_Distribution_Channel_Filter_XML](#valid_for_distribution_channel_filter_xml)|`nvarchar` |When not NULL, the package is valid only if the specified distribution channel of the sales order fits in the filter criteria.|
