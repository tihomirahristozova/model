# Query Scm_Requisition_Lines_Table_Load_Navigator
...
|[Requested_By_Party_Id](#requested_by_party_id)|`uniqueidentifier` ||
...
|[Suggested_Supplier_Id](#suggested_supplier_id)|`uniqueidentifier` ||
|[Required_Delivery_Date_Lines](#required_delivery_date_lines)|`datetime` ||
...
|Attributes|None|
|Default Value|None|
|Derived From|[Scm_Requisitions](Scm_Requisitions.md).[Store_Id](Scm_Requisitions.md#store_id)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None|
|Default Value|None|
|Derived From|[Scm_Requisitions](Scm_Requisitions.md).[Requested_By_Party_Id](Scm_Requisitions.md#requested_by_party_id)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None|
|Default Value|None|
|Derived From|[Scm_Requisitions](Scm_Requisitions.md).[Required_Delivery_Date](Scm_Requisitions.md#required_delivery_date)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None|
|Default Value|NewGuid|
|Derived From|[Scm_Requisitions](Scm_Requisitions.md).[Requisition_Id](Scm_Requisitions.md#requisition_id)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
...
|Attributes|None, IsLongString|
|Default Value|None|
|Derived From|[Scm_Requisitions](Scm_Requisitions.md).[Notes](Scm_Requisitions.md#notes)|
|Format||
|Ignore for Insert Order|no|
|Auto Complete|no|
|Data Filter|no|
