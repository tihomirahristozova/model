# Query Inv_Transfer_Order_Lines_Table_Load_Navigator
...
|[To_Store_Id](#to_store_id)|`uniqueidentifier` ||
...
|[From_Store_Bin_Id](#from_store_bin_id)|`uniqueidentifier` ||
|[To_Store_Bin_Id](#to_store_bin_id)|`uniqueidentifier` ||
...
|[Default_Due_Date_Out](#default_due_date_out)|`datetime` ||
|[Default_Due_Date_In](#default_due_date_in)|`datetime` ||
...
|[Due_Date_Out](#due_date_out)|`datetime` ||
|[Due_Date_In](#due_date_in)|`datetime` ||
