# Query Fleet_Trips_Table_Load_Navigator
...
|[Trip_Id](#trip_id)|`uniqueidentifier` `PK`||
|[Document_Id](#document_id)|`uniqueidentifier` ||
|[Vehicle_Set_Id](#vehicle_set_id)|`uniqueidentifier` ||
|[Crew_Id](#crew_id)|`uniqueidentifier` ||
|[Primary_Vehicle_Starting_Mileage](#primary_vehicle_starting_mileage)|`decimal(0, 0)` ||
|[Primary_Vehicle_Ending_Mileage](#primary_vehicle_ending_mileage)|`decimal(0, 0)` ||
