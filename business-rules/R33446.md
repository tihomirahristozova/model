...
| Message | Composite product component "{CompositeProductCoponent}" contains products with variable measurement ratios, which is not allowed. <br/> Please make sure that both the composite product and its components do not use variable measurement ratios. |
