...
| Message | Composite products do not support variable measurement ratios, but component "{CompositeProductCoponent}" violates this rule <br/> Please make sure that both the composite product and its components do not allow variable measurement ratios. |
