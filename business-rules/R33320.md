...
| Message | The 'Quantity Base' field in warehouse transaction '{WarehouseTransaction.DisplayText}' contains an invalid value. <br/> When the transaction measurement unit is the same as the base measurement unit of the product, then the Quantity and QuantityBase values must also be the same. |
