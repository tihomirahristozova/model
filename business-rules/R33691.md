...
| Priority | Normal |
| Modify | NO |
| Action | For each Release on the ServiceAgreement validate that the old value in, <br> <br> ServiceAgreementServices.Quantity < <br> ServiceActivity.DistributedServiceAgreementMaterials.AgreedQuantity |
