...
| Status                          | [NEW](https://confluence.erp.net/display/techdoc/Generation+Procedures+Lifetime+Stages) |
| Supports Transitional Documents | NO                                                           |
| Replaces                        | [Obsolete] Create store transactions for the distributed amounts (To be deleted: 6.2021; use FIN0801) |
| Orphan Rows                     | Ignore                                                       |
