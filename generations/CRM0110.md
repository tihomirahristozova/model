...
So if at least one of **StoreOrderRemainingStandardQuantityBase** or ***\*StoreOrder\**Remaining****ReturnedCost** is different from 0, a new StoreOrderLine is created as follows:
