...
| ---- | ---- | --- |
| [<s>Active</s>](Logistics.Inventory.Stores.md#active) | boolean __nullable__ | **OBSOLETE! Do not use!** Obsolete - Use Gen_Parties.Is_Active. `Obsolete` 
...
**OBSOLETE! Do not use!** Obsolete - Use Gen_Parties.Is_Active. `Obsolete`
