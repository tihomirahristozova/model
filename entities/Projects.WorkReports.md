...
| [ParentDocument<br />RelationshipType](Projects.WorkReports.md#parentdocumentrelationshiptype) | [ParentDocument<br />RelationshipType](Projects.WorkReports.md#parentdocumentrelationshiptype) (nullable) | Type of relationship between the current document and the parent document(s). Affects the constraints for execution/completion for the documents. Possible values: 'S' = 'Subtask', 'N' = 'Next task'. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
