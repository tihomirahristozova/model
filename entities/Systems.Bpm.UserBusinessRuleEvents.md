...
[!list erp.entity=Systems.Bpm.UserBusinessRuleEvents erp.type=generation default-text="None"]
...
Table API Query:
<https://demodb.my.erp.net/api/domain/odata/Sys_User_Business_Rule_Events?$top=10>
