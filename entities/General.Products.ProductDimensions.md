...
| [DestQuantity](General.Products.ProductDimensions.md#DestQuantity) | [Quantity](../data-types/Quantity.md) | Quantity in some of the base units, that equals Source_Quantity. [Unit: DestQuantityUnit] [Required] [Default(1)] 
| [SourceQuantity](General.Products.ProductDimensions.md#SourceQuantity) | [Quantity](../data-types/Quantity.md) | The quantity in the non-base unit. [Unit: SourceQuantityUnit] [Required] [Default(1)] 
...
Table API Query:
<https://demodb.my.erp.net/api/domain/odata/Gen_Product_Dimensions?$top=10>
