...
| [AdjustmentTime](Logistics.Shipment.TransportationRequisitions.md#adjustmenttime) | datetime __nullable__ | Date/time when the document last has been adjusted by corrective document. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
...
| [DocumentRowVersion](Logistics.Shipment.TransportationRequisitions.md#documentrowversion) | byte[] |  
...
| [ReferenceDate](Logistics.Shipment.TransportationRequisitions.md#referencedate) | datetime __nullable__ | The date to which this document refers, i.e. when the action really occurred. If null, Document_Date is taken. `Default(Today)` `Filter(ge;le)` (Inherited from [Documents](General.Documents.md)) 
...
| [RowVersion](Logistics.Shipment.TransportationRequisitions.md#rowversion) | byte[] |  
...
| [VoidTime](Logistics.Shipment.TransportationRequisitions.md#voidtime) | datetime __nullable__ | Date/time when the document has become void. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
