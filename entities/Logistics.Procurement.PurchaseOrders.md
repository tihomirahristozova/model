...
| [AdjustmentUser](Logistics.Procurement.PurchaseOrders.md#adjustmentuser) | string(64) (nullable) | The user who adjusted the document. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
...
| [CreationUser](Logistics.Procurement.PurchaseOrders.md#creationuser) | string(64) | The login name of the user, who created the document. `Required` `Filter(like)` `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
...
| [DocumentNotes](Logistics.Procurement.PurchaseOrders.md#documentnotes) | string(2147483647) (nullable) | Notes for this Document. (Inherited from [Documents](General.Documents.md)) 
...
| [InvoiceDocumentNo](Logistics.Procurement.PurchaseOrders.md#invoicedocumentno) | string(20) (nullable) | Contains the purchase invoice number when it is known in advance, null otherwise. `Filter(eq)` 
...
| [Notes](Logistics.Procurement.PurchaseOrders.md#notes) | string(2147483647) (nullable) | Notes for this PurchaseOrder. 
...
| [ReferenceDocumentNo](Logistics.Procurement.PurchaseOrders.md#referencedocumentno) | string(20) (nullable) | The number of the document (issued by the other party), which was the reason for the creation of the current document. The numebr should be unique within the party documents. `Filter(eq;like)` (Inherited from [Documents](General.Documents.md)) 
...
| [VoidReason](Logistics.Procurement.PurchaseOrders.md#voidreason) | string(254) (nullable) | Reason for voiding the document, entered by the user. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
...
| [VoidUser](Logistics.Procurement.PurchaseOrders.md#voiduser) | string(64) (nullable) | The user who voided the document. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
