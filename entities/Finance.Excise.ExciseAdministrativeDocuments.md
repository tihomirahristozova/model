...
| [PlanningOnly](Finance.Excise.ExciseAdministrativeDocuments.md#planningonly) | boolean | Indicates that the document is used only for planning (and as consequence its state cannot be greater than Planned). `Required` `Default(false)` `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
| [ReadOnly](Finance.Excise.ExciseAdministrativeDocuments.md#readonly) | boolean | True - the document is read only; false - the document is not read only. `Required` `Default(false)` `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
| [ReferenceDate](Finance.Excise.ExciseAdministrativeDocuments.md#referencedate) | datetime __nullable__ | The date to which this document refers, i.e. when the action really occurred. If null, Document_Date is taken. `Default(Today)` `Filter(ge;le)` (Inherited from [Documents](General.Documents.md)) 
...
| [ReleaseTime](Finance.Excise.ExciseAdministrativeDocuments.md#releasetime) | datetime __nullable__ | Date and time when the document was released (State set to Released). `Filter(ge;le)` `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
...
| [Void](Finance.Excise.ExciseAdministrativeDocuments.md#void) | boolean | True if the document is null and void. `Required` `Default(false)` `Filter(eq)` `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
| [VoidReason](Finance.Excise.ExciseAdministrativeDocuments.md#voidreason) | string (254) __nullable__ | Reason for voiding the document, entered by the user. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
| [VoidTime](Finance.Excise.ExciseAdministrativeDocuments.md#voidtime) | datetime __nullable__ | Date/time when the document has become void. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 
| [VoidUser](Finance.Excise.ExciseAdministrativeDocuments.md#voiduser) | string (64) __nullable__ | The user who voided the document. `ReadOnly` (Inherited from [Documents](General.Documents.md)) 

## References

| Name | Type | Description |
| ---- | ---- | --- |
| [AccessKey](Finance.Excise.ExciseAdministrativeDocuments.md#accesskey) | [AccessKeys](Systems.Security.AccessKeys.md) (nullable) | The access key, containing the user permissions for this document. null means that all users have unlimited permissions. `Filter(multi eq)` (Inherited from [Documents](General.Documents.md)) |
| [AdjustedDocument](Finance.Excise.ExciseAdministrativeDocuments.md#adjusteddocument) | [Documents](General.Documents.md) (nullable) | The primary document, which the current document adjusts. null when this is not an adjustment document. `Filter(multi eq)` `ReadOnly` (Inherited from [Documents](General.Documents.md)) |
...
| [DocumentCurrency](Finance.Excise.ExciseAdministrativeDocuments.md#documentcurrency) | [Currencies](General.Currencies.md) | Currency of the Excise deal. `Required` `Filter(multi eq)` `Introduced in version 21.1.3.87` |
...
| [ReporterPerson](Finance.Excise.ExciseAdministrativeDocuments.md#reporterperson) | [Persons](General.Contacts.Persons.md) | Reporter Person. `Required` `Filter(multi eq)` `Introduced in version 21.1.3.92` |
...
Currency of the Excise deal. `Required` `Filter(multi eq)` `Introduced in version 21.1.3.87`
...
Reporter Person. `Required` `Filter(multi eq)` `Introduced in version 21.1.3.92`
