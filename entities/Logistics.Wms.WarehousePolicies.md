...
| KittingControllingLevel | KittingControllingLevel value. Stored as 'KCL'. <br /> _Database Value:_ 'KCL' <br /> _Model Value:_ 8 <br /> _Domain API Value:_ 'KittingControllingLevel' |
| DekittingControllingLevel | DekittingControllingLevel value. Stored as 'DCL'. <br /> _Database Value:_ 'DCL' <br /> _Model Value:_ 9 <br /> _Domain API Value:_ 'DekittingControllingLevel' |
